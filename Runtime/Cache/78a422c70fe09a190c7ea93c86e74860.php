...
<div class=" o_f bline infotab ">
  下单日期：<?php echo (date('Y-m-d H:i:s',$info["create_time"])); ?>
</div>

<div class=" o_f bline infotab ">
  退货单号：<?php echo ($refund["refund_sn"]); ?>
</div>

<div class=" o_f bline infotab ">
  退货日期：<?php echo (date('Y-m-d H:i:s',$refund["time"])); ?>
</div>

<div class="bundlev bline">
  <span class="storeico"></span><?php echo ($info["location_name"]); ?>退货详情
</div>
    
<?php if(is_array($refund_info)): $i = 0; $__LIST__ = $refund_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><div class="productlist box_flex bline">
    <div class="leftimg">
      <a href="<?php echo U('SupGoods/detail',array('id'=>$goods['goods_id']));?>"><img src="<?php echo ($goods["thumbnail"]); ?>"></a>
    </div>
    <div class="rightinfo flex1">
      <h3><a href="<?php echo U('SupGoods/detail',array('id'=>$goods['goods_id']));?>"><?php echo ($goods["goods_name"]); ?></a></h3>
      <div class="d-main">
        <span class="price">￥:<?php echo (price($goods["price"])); ?></span> 
...
<div class="o_f addinfo">
  <div class="">
    <p class="o_f ">
      ...
      <span class="pull-right"><?php echo ($info["receive_tel"]); ?></span>
    </p>
  </div>
</div>
...
<div class="bundlev bline">
  <p>
    ...
    <span class="pull-right"><?php echo ($refund_info[0]["warehouse_name"]); ?></span>
  </p>
</div>
<div class="bundlev bline">
  <p>
    <span class="pull-left">退货金额：</span>
    <span class="pull-right price">￥:<?php echo (price($refund_info[0]["total_price"])); ?></span>
  </p>
</div>
...
<div class="bundlev bline">
  <p>
    ...
    <span class="pull-right"><?php if($refund_info[0]['type'] == 1): ?>部分退货<?php else: ?>全部退货<?php endif; ?></span>
  </p>
</div>
...
<div class="bundlev bline">
  <p>
    ...
    <span class="pull-right"><?php if($refund_info[0]['refund_money_type'] == 1): ?>退钱<?php elseif($refund_info[0]['refund_money_type'] == 2): ?>核销<?php elseif($refund_info[0]['refund_money_type'] == 3): ?>预存款<?php else: ?>-<?php endif; ?></span>
  </p>
</div>
...
<div class="bundlev bline">
  <p>
    ...
    <span class="pull-right"><?php echo ($refund_info[0]["user_name"]); ?></span>
  </p>
</div>

<div class="bundlev o_f">
  <p>
    退货备注：<?php echo ($refund_info["remark"]); ?>
  </p>
</div>
