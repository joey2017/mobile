...
</script><link rel="stylesheet" href="__PUBLIC__/font-awesome/css/font-awesome.min.css"><link rel="stylesheet" href="__PUBLIC__/css/iconfont.css" /><link rel="stylesheet" href="__PUBLIC__/css/text.css" /></head><body><style type="text/css">/*布局样式重置*/
...
</script><div class="col-xs-12"><div class="xqtitle"><h1><?php echo ($info["goods_name"]); ?></h1></div><div class="price_quantity box_flex"><div class="flex1"><p><?php if($info['promotion_price'] != 0): ?>促销价<?php else: ?>批发价<?php endif; ?><span class="price">￥<?php if($info['promotion_price'] != 0): echo (price($info["promotion_price"])); else: echo (price($info["price"])); endif; ?></span><?php if($info["unit"] != 0): ?>/<?php echo ($info["unit"]); endif; ?></p><?php if($info['promotion_price'] != 0): ?><p style="font-size: 12px;">批发价<del><span class="">￥<?php echo (price($info["price"])); if($info["unit"] != 0): ?>/<?php echo ($info["unit"]); endif; ?></span></del></p><?php endif; ?><p style="font-size: 12px;">零售价<span class="">￥<?php echo (price($info["market_price"])); if($info["unit"] != 0): ?>/<?php echo ($info["unit"]); endif; ?></span></p></div><div class="pull-right"><div class="setbox"><input class="min" name="" type="button" value="-" /><input class="text_box" disabled type="number" name="goods_num" id="goods_num" type="text" value="1" /><input class="add" name="" type="button" value="+" /></div><div class="j_indPanel"><span class="pull-right sold">已售 <?php echo ($info["sales"]); ?></span></div></div></div><div><span class="pull-right price" style="margin-bottom:10px;font-size: 12px; margin-top: -5px;"><?php echo ($info["supplier_name"]); ?></span></div></div><div style="clear: both;"><ul class="nav nav-tabs box_flex" id="myTab"><li class="flex1"><a href="#details" data-toggle="tab">商品详情</a></li><li class="flex1"><a href="#parameter" data-toggle="tab">规格参数</a></li><li class="flex1"><a href="#deal" data-toggle="tab">适用车型</a></li></ul></div><div class="tab-content"><div class="tab-pane" id="details"><?php echo ($info["detail"]); ?></div><div class="tab-pane" id="parameter"><table class="table table-bordered"><?php if(is_array($attr_names)): $i = 0; $__LIST__ = $attr_names;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$an): $mod = ($i % 2 );++$i;?><tr><td align="right" width="120" class="tdbg"><?php echo ($an); ?></td><td><?php echo ($attr_vals[$key]); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?></table></div><div class="tab-pane" id="deal"><table class="table table-bordered"><?php if(is_array($car)): $i = 0; $__LIST__ = $car;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr><td align="right" width="120" class="tdbg"><?php echo ($c["cate2"]); ?></td><td><?php echo ($c["cate3"]); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?></table></div></div><!--底栏--><!--漂浮导航 开始--><div class="row pos-nav"><div class="col-xs-3"><a href="<?php echo U('Supplier/index');?>" <?php if(MODULE_NAME == Supplier): ?>class="nav-red"<?php endif; ?>><i class="iconfont icon-shangdian1"></i><p>首页</p></a></div><div class="col-xs-3"><a href="<?php echo U('SupOrder/navig');?>" <?php if(MODULE_NAME == SupOrder): ?>class="nav-red"<?php endif; ?>><i class="iconfont icon-kehu"></i><p>交易/客户</p></a></div><div class="col-xs-3"><a href="<?php echo U('SupWarehouse/navig');?>" <?php if(MODULE_NAME == SupWarehouse): ?>class="nav-red"<?php endif; ?>><i class="iconfont icon-kucun"></i><p>财务/库存</p></a></div><div class="col-xs-3"><a href="<?php echo U('SupMember/navig');?>" <?php if(MODULE_NAME == SupMember): ?>class="nav-red"<?php endif; ?>><i class="iconfont icon-shouhou"></i><p>售后</p></a></div></div><!--漂浮导航 结束--></body></html><script type="text/javascript">document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
