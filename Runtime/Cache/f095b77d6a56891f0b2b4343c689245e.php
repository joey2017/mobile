...
</script><link rel="stylesheet" href="__PUBLIC__/font-awesome/css/font-awesome.min.css"><link rel="stylesheet" type="text/css" href="__PUBLIC__/css/text.css"/><link rel="stylesheet" href="__PUBLIC__/css/iconfont.css" /></head><body class="drawer drawer-right"><link rel="stylesheet" href="__PUBLIC__/css/drawer.min.css"><script type="text/javascript" src="__PUBLIC__/js/sup.common.js"></script><style type="text/css">/*导航*/
...
.sort_sele{display: none; width: 100%; position: absolute; top: 42px; left: 0; background: #fff; padding:0 15px 10px 15px; z-index: 1; text-align: left;-webkit-box-shadow: 0 1px 3px #afafaf;  -moz-box-shadow: 0 1px 3px #afafaf; box-shadow: 0 1px 3px #afafaf;}
...
.no_record{height: 24px;  padding-top: 205px;  text-align: center;  background: url(http://s.17cct.com/v5/images/erp/empty.png) no-repeat center 20px;  background-size: 180px 180px;}
...
</style><div class="alertBg" id="msgBox" style="display:none;"><h4 class="alerttitle" id="alerttitle"></h4><span class="vm f20" id='alertdetail'></span></div><div class="drawer-main drawer-default"><nav role="navigation" id="attr_list" style="height:auto;"><div class="sift_row"><div class="row_title">				订单状态
				<span class="fa fa-caret-down pull-right"></span></div><div class="row_body"><ul class="row li_choose"><li class="col-xs-4"><a href="javascript:;" class="tc_project tc_choose" value="0">不限</a></li><li class="col-xs-4"><a href="javascript:;" class="tc_project" value="status:4">已发货</a></li><li class="col-xs-4"><a href="javascript:;" class="tc_project" value="status:5">已收货</a></li></ul></div></div><div class="sift_row"><div class="row_title">                支付状态
                <span class="fa fa-caret-down pull-right"></span></div><div class="row_body"><ul class="row li_choose"><li class="col-xs-4"><a href="javascript:;" class="tc_project tc_choose" value="0">不限</a></li><li class="col-xs-4"><a href="javascript:;" class="tc_project" value="pay_status:1">已付款</a></li><li class="col-xs-4"><a href="javascript:;" class="tc_project" value="pay_status:2">已收款</a></li></ul></div></div><div class="sift_row"><div class="row_title">                区域经理
                <span class="fa fa-caret-down pull-right"></span></div><div class="row_body"><ul class="row li_choose"><li class="col-xs-4"><a href="javascript:;" class="tc_project tc_choose" value="0">不限</a></li><?php if(is_array($employee_list)): $k = 0; $__LIST__ = $employee_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$el): $mod = ($k % 2 );++$k;?><li class="col-xs-4"><a href="javascript:;" class="tc_project" value="employee_id:<?php echo ($el["id"]); ?>"><?php echo ($el["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div></div></nav><div class="sift_bottom"><div class="sift-btn" id="reset_attr">			重置
		</div><div class="sift-btn sift-btn-ok" onclick="$('.drawer').drawer('close');">			确定
		</div></div></div><input type="hidden" id="sort" value="0"><input type="hidden" id="attr_value" value=""><div class=""><div class="topsearch col-xs-12 box_flex"><div class="flex1 searchtab"><span></span><input type="text" class="form-control enter-search" id="keyword" value="" placeholder="请输入订单号/门店名称"></div><div class="searchbtn"><button onclick="search_goods(2)">搜索</button></div></div><div class="screen"><div class="col-xs-6 sepline"><a href="javascript:;" id="comprehensive">综合排序 <span class="arrowico"></span></a></div><div class="col-xs-6 js-trigger">筛选 <span class="screenico"></span></div><div class="sort_sele"><p class="ptick tick" onclick="mob.setSort(0,this)"><a href="javascript:;">综合排序</a><span></span></p><p class="ptick" onclick="mob.setSort(1,this)"><a href="javascript:;">订单价格从低到高</a><span></span></p><p class="ptick" onclick="mob.setSort(2,this)"><a href="javascript:;">订单价格从高到低</a><span></span></p><p class="ptick" onclick="mob.setSort(3,this)"><a href="javascript:;">下单时间从高到低</a><span></span></p><p class="ptick" onclick="mob.setSort(4,this)"><a href="javascript:;">下单时间从低到高</a><span></span></p></div></div><script type="text/javascript">        $(function(){
            $('.drawer').drawer();
        ...
        mob.init("<?php echo U('SupMember/can_refund_list');?>","#order_list",dataInfo);
