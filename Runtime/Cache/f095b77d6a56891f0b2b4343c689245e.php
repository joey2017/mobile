...
<div class="">
    ...
    <div class="screen">
		...
		<div class="sort_sele">
			...
			<p class="ptick" onclick="mob.setSort(1,this)"><a href="javascript:;">订单价格从低到高</a><span></span></p>
			<p class="ptick" onclick="mob.setSort(2,this)"><a href="javascript:;">订单价格从高到低</a><span></span></p>
			<p class="ptick" onclick="mob.setSort(3,this)"><a href="javascript:;">下单时间从高到低</a><span></span></p>
			<p class="ptick" onclick="mob.setSort(4,this)"><a href="javascript:;">下单时间从低到高</a><span></span></p>
		</div>
