...
<div class="">
    ...
    <div class="screen">
		...
		<div class="sort_sele">
			...
			<p class="ptick" onclick="mob.setSort(3,this)"><a href="javascript:;">销量从高到低</a><span></span></p>
			<p class="ptick" onclick="mob.setSort(4,this)"><a href="javascript:;">销量从低到高</a><span></span></p>
		</div>
	        ...
	        <?php if(is_array($class_list)): $i = 0; $__LIST__ = $class_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><li>
	            	...
	            	<ul aria-expanded="false" class="collapse">
	                  <?php if(is_array($c['item'])): $i = 0; $__LIST__ = $c['item'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ci): $mod = ($i % 2 );++$i;?><li <?php if($ci["id"] == $t): ?>class="select"<?php endif; ?>>
	                  			<a href="<?php echo U('SupWarehouse/stockAlarm',array('t'=>$ci['id']));?>" class="present"><?php echo ($ci["class_name"]); ?> <i class="fa fa-angle-right pull-right"></i></a>
	                		</li><?php endforeach; endif; else: echo "" ;endif; ?>
	            	</ul>
	          	</li><?php endforeach; endif; else: echo "" ;endif; ?>
	        </ul>
    ...
    <script type="text/javascript">
        ...
        mob.init("<?php echo U('SupWarehouse/ajax_get_alarm_goods');?>","#goods_list",dataInfo);
