...
<div class="">
    ...
    <div class="screen">
		...
		<div class="sort_sele">
			...
			<p class="ptick" onclick="mob.setSort(1,this)"><a href="javascript:;">交易额从低到高</a><span></span></p>
			<p class="ptick" onclick="mob.setSort(2,this)"><a href="javascript:;">交易额从高到低</a><span></span></p>
			<p class="ptick" onclick="mob.setSort(3,this)"><a href="javascript:;">订单数量从高到低</a><span></span></p>
			<p class="ptick" onclick="mob.setSort(4,this)"><a href="javascript:;">订单数量从低到高</a><span></span></p>
		</div>
    </div>
    ...
    <script type="text/javascript">
        ...
        mob.init("<?php echo U('SupMember/ajax_get_member');?>","#member_list .brief",dataInfo);
