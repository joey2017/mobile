...
</script><link rel="stylesheet" href="__PUBLIC__/font-awesome/css/font-awesome.min.css"><link rel="stylesheet" type="text/css" href="__PUBLIC__/css/text.css"/><link rel="stylesheet" href="__PUBLIC__/css/iconfont.css" /><script type="text/javascript" src="__PUBLIC__/js/sup.common.js"></script></head><body class="drawer drawer-right"><link rel="stylesheet" href="__PUBLIC__/css/drawer.min.css"><style type="text/css">/*导航*/
...
.no_record{height: 24px;  padding-top: 205px;  text-align: center;  background: url(http://s.17cct.com/v5/images/erp/empty.png) no-repeat center 20px;  background-size: 180px 180px;}
...
</style><div class="alertBg" id="msgBox" style="display:none;"><h4 class="alerttitle" id="alerttitle"></h4><span class="vm f20" id='alertdetail'></span></div><div class="drawer-main drawer-default"><nav role="navigation" id="attr_list" style="height:auto;"><div class="sift_row"><div class="row_title">                支付状态
		...
		</div></div></div><input type="hidden" id="sort" value="0"><input type="hidden" id="attr_value" value=""><div class=""><div class="topsearch col-xs-12 box_flex"><div class="flex1 searchtab"><span></span><input type="text" class="form-control enter-search" id="keyword" value="" placeholder="退货单号/门店名称"></div><div class="searchbtn"><button>搜索</button></div></div><div class="screen"><div class="col-xs-6 sepline"><a href="javascript:;" id="comprehensive">综合排序 <span class="arrowico"></span></a></div><!-- <div class="col-xs-4 sepline"><a href="javascript:;" id="classification"><?php echo ($class_name); ?><span class="arrowico"></span></a></div> --><div class="col-xs-6 js-trigger">筛选 <span class="screenico"></span></div><div class="sort_sele"><p class="ptick tick" onclick="mob.setSort(0,this)"><a href="javascript:;">综合排序</a><span></span></p><p class="ptick" onclick="mob.setSort(1,this)"><a href="javascript:;">订单价格从低到高</a><span></span></p><p class="ptick" onclick="mob.setSort(2,this)"><a href="javascript:;">订单价格从高到低</a><span></span></p><p class="ptick" onclick="mob.setSort(3,this)"><a href="javascript:;">下单时间从高到低</a><span></span></p><p class="ptick" onclick="mob.setSort(4,this)"><a href="javascript:;">下单时间从低到高</a><span></span></p></div></div><script type="text/javascript">        $(function(){
            $('.drawer').drawer();
        ...
        mob.init("<?php echo U('SupMember/get_order_refund');?>","#order_list",dataInfo);
