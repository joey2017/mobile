...
.tab_subset{margin:0;}
a{color: #333;}
a:focus,a:active, a:hover{color: #33; text-decoration: none;}
...
.searchtab input{border:0; background:#efefef; }
...
/*.my_od_bottom{border-top: 1px solid #e0e0e0;}*/
...
<div class="">
	<div class="topsearch_min col-xs-12 box_flex">
		<div class="flex1 searchtab">
			<input type="text" class="form-control" readonly id="keyword" value="<?php echo ($goods["goods_name"]); ?>">
		</div>
	</div>
	<div class="topsearch_min col-xs-12 box_flex" style="margin-bottom: 10px;">
		<div class="col-xs-6 tab_subset sepline" style="padding-left: 0">
			<input type="text" class="form-control" id="start_time" name="start_time" value="<?php if($start_time != null): echo (date("Y-m-d",$start_time)); endif; ?>" readonly data-val="<?php echo ($start_time); ?>" placeholder="起始时间">
		</div>
		<div class="col-xs-6 tab_subset" style="padding-right: 0">
			<input type="text" class="form-control" id="end_time" name="end_time" value="<?php if($start_time != null): echo (date("Y-m-d",$end_time)); endif; ?>" readonly data-val="<?php echo ($end_time); ?>" placeholder="结束时间">
		</div>
	</div>
...
<script type="text/javascript">
    ...
    var id        		= $('#goods_id').val(),
        start_time      = $('#start_time').attr('data-val'),
        end_time        = $('#end_time').attr('data-val');
    var dataInfo = {
        id:id,
        start_time:start_time,
        end_time:end_time
    };
    mob.init("<?php echo U('SupSale/lists');?>","#order_list",dataInfo);
