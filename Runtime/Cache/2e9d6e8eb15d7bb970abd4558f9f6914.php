...
<div class="col-xs-12" style="margin-bottom: 10px;">
	...
	<div class="row shoujia" style="text-align: center">
		<div class="col-xs-4">
			<p><?php if($info['promotion_price'] != 0): ?>促销价<?php else: ?>批发价<?php endif; ?></p>
			<strong><?php if($info['promotion_price'] != 0): echo (price($info["promotion_price"])); else: echo (price($info["price"])); endif; ?></strong>
		</div>
		<div class="col-xs-4">
			<p>零售价</p>
			<strong><?php echo (price($info["market_price"])); ?></strong>
		</div>
		<div class="col-xs-4">
			<p>销量</p>
			<strong><?php echo ($info["sales"]); ?></strong>
		</div>
	</div>
</div>
...
<div style="clear: both;">
	<ul class="nav nav-tabs box_flex" id="myTab">
        ...
        <li class="flex1"><a href="#warehouse" data-toggle="tab">库存详情</a></li>
	</ul>
</div>
<div class="tab-content">
	...
	<div class="tab-pane" id="warehouse">
		<table class="table table-bordered">
			<?php if(is_array($warehouse_goods)): $i = 0; $__LIST__ = $warehouse_goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wg): $mod = ($i % 2 );++$i;?><tr>
					<td align="right" width="120" class="tdbg"><?php echo ($wg["warehouse_name"]); ?></td>
					<td><?php echo ($wg["stock"]); ?></td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
		</table>
	</div>
</div>
