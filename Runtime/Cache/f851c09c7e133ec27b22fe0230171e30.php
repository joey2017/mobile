...
<!--//Custom Theme files -->
<link href="__PUBLIC__/css/error_style.css" rel="stylesheet" type="text/css" media="all" />
...
<body>
	...
	<!--//main -->
	<div class="copyright">
		<p> &copy; 2012-<?php echo date('Y');?> Purple 404 Error page . All rights reserved | Design by <a href="http://w3layouts.com/" target="_blank" >cct</a></p>
	</div>
</body>
</html>