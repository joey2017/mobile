<?php
 if (!class_exists('UpYunException')){ 
...
if (!class_exists('UpYunAuthorizationException')){ 
...
if (!class_exists('UpYunForbiddenException')){ 
...
if (!class_exists('UpYunNotFoundException')){ 
...
if (!class_exists('UpYunNotAcceptableException')){ 
...
if (!class_exists('UpYunServiceUnavailable')){ 
